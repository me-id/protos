...
@kotlin.jvm.JvmName("setAlso")
    ...
    /**
     * `bytes core_cbor = 11 [json_name = "coreCbor"];`
     */
    ...
    /**
     * `repeated string key_history = 12 [json_name = "keyHistory"];`
...
@kotlin.jvm.JvmName("setKeyHistory")
     ...
     * ```
     *
     * `repeated .didme.VMKey vm = 13 [json_name = "vm"];`
     */
...
@kotlin.jvm.JvmName("clearVm")
    ...
    /**
     * `repeated string authn = 14 [json_name = "authn"];`
...
@kotlin.jvm.JvmName("setAuthn")
    ...
    /**
     * `repeated string assert = 15 [json_name = "assert"];`
...
@kotlin.jvm.JvmName("setAssert")
    ...
    /**
     * `repeated string inv = 16 [json_name = "inv"];`
...
@kotlin.jvm.JvmName("setInv")
    ...
    /**
     * `repeated string ka = 17 [json_name = "ka"];`
...
@kotlin.jvm.JvmName("setKa")
     ...
     * ```
     *
     * `repeated .didme.Service svc = 18 [json_name = "svc"];`
     */
...
@kotlin.jvm.JvmName("clearSvc")
     ...
     * ```
     *
     * `.didme.UpdatePolicy policy = 19 [json_name = "policy"];`
     */
    ...
    /**
     * `repeated .didme.Attestation att = 20 [json_name = "att"];`
     */
...
@kotlin.jvm.JvmName("clearAtt")
     ...
     * ```
     *
     * `.didme.Proof proof = 21 [json_name = "proof"];`
     */
     ...
     * ```
     *
     * `repeated .didme.DomainVerification dv = 22 [json_name = "dv"];`
     */
